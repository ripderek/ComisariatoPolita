...
function Hero() {
  return (
    ...
    style={{
      backgroundImage: "linear-gradient(to right, rgba(150,0,0,0.8), rgba(150,0,0,0.8)), url('/image/fondo.jpg')",
    }}
  >
      {/* 
      ...
      */}
      ...
      <div className="mx-8 lg:mx-16 -mt-24 rounded-xl bg-white p-5 md:p-14 shadow-2xl">
        <div>
          ...
          >
          Somos una tienda comprometida con la satisfacción de nuestros clientes. Ofrecemos una amplia variedad de productos frescos y de calidad.
          </Typography>
        </div>
      </div>
    </div>
